...
for date in combined_df.index.unique():
    ...
    if len(SPY_data) > 0 and SPY_data['150ma'].values[0] > SPY_data['prevClose'].values[0] and SPY_data['50ma'].values[0] > SPY_data['prevClose'].values[0]  :#and IYK_data['200ma'].values[0] > IYK_data['prevClose'].values[0]:
        IsHell = True
