...
##########################################################################################################
    ...
    df = pyupbit.get_ohlcv(coin_ticker,interval="day",count=2413, period=0.3) #day/minute1/minute3/minute5/minute10/minute15/minute30/minute60/minute240/week/month
    print(len(df))
