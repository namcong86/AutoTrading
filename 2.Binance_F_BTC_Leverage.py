...
for coin_data in InvestCoinList:
    ...
    # --- 매수 로직 (포지션 없음) ---
        ...
        telegram_alert.SendMessage(analysis_msg)
        buy = cond_o1 and cond_o2 and cond_close_inc and cond_high_inc and cond_5ma and cond_5ma_bf and cond_20ma and cond_60ma and cond_slope and cond_rsi_inc and cond_MACD
        if buy:
